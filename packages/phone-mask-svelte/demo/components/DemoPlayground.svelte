      ...
      <div class="control-group">
        <label class="label">
          ...
          <select
            ...
            onchange={(e) => {
              country = ((e.target as HTMLSelectElement).value as CountryKey) || undefined;
            }}
          >
        ...
        <label class="label">
          ...
          <select
            ...
            onchange={(e) => {
              locale = (e.target as HTMLSelectElement).value || undefined;
            }}
          >
            <option value="">Not Selected</option>
        ...
        <label class="label">
          ...
          <select
            ...
            onchange={(e) => {
              size = (e.target as HTMLSelectElement).value as Size;
            }}
          >
      ...
      <div class="control-group">
        <label class="label">
          ...
          <input
            ...
            oninput={(e) => {
              searchPlaceholder = (e.target as HTMLInputElement).value;
            }}
            type="text"
            class="input"
        ...
        <label class="label">
          ...
          <input
            value={noResultsText}
            oninput={(e) => {
              noResultsText = (e.target as HTMLInputElement).value;
            }}
            type="text"
            class="input"
        ...
        <label class="label">
          ...
          <input
            ...
            oninput={(e) => {
              clearButtonLabel = (e.target as HTMLInputElement).value;
            }}
            type="text"
            class="input"
        ...
        <label class="label">
          ...
          <input
            value={dropdownClass}
            oninput={(e) => {
              dropdownClass = (e.target as HTMLInputElement).value;
            }}
            type="text"
            class="input"
      ...
      <div class="control-group">
        ...
        <label class="checkbox-label" data-testid="props-show-copy">
          <input
            ...
            class="checkbox"
            onchange={(e) => {
              showCopy = (e.target as HTMLInputElement).checked;
            }}
          />
        ...
        <label class="checkbox-label" data-testid="props-show-clear">
          <input
            ...
            class="checkbox"
            onchange={(e) => {
              showClear = (e.target as HTMLInputElement).checked;
            }}
          />
        ...
        <label class="checkbox-label" data-testid="props-with-validity">
          <input
            ...
            class="checkbox"
            onchange={(e) => {
              withValidity = (e.target as HTMLInputElement).checked;
            }}
          />
        ...
        <label class="checkbox-label" data-testid="props-disable-default-styles">
          <input
            ...
            class="checkbox"
            onchange={(e) => {
              disableDefaultStyles = (e.target as HTMLInputElement).checked;
            }}
          />
