...
const dropdownStyles = computed(() => ({ positionAnchor: anchorName }) as CSSProperties);
</script>
...
// Root (dropdown shares theme variables)
.phone-input,
.phone-dropdown {
...
.pi-options {
  max-height: var(--pi-dropdown-max-height, 300px);
  min-height: 0;
  flex: 1 1 auto;
  overflow-y: auto;
  padding: 4px 0;
